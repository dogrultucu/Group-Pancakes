def panFire(x, y, z):
    ...
    x_input = input("Enter x coordinate (default 600): ").strip()
    y_input = input("Enter y coordinate (default 600): ").strip()
    ...
    if (
        ...
        x = 600
        print("No x input. Using default position: 600")
    else:
        try:
            ...
            x = 600
            print(f"Invalid x input '{x_input}'. Using default position: 600")
            # If number converts to int. Print return input to user

    # Process y coordinate
    if y_input == "":
        y = 600
        print("No y input. Using default position: 600")
    else:
        try:
            y = int(y_input)
            ...
            y = 600
            print(f"Invalid y input '{y_input}'. Using default position: 600")
